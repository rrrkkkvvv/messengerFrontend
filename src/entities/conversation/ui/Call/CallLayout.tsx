...
const CallLayout = () => {
  ...
  const styleCall = () => {
    if (isHidden) {
      ...
      return ` 
      text-white animate-fadeIn transition-all duration-300     md:rounded-lg  fixed z-50  bg-blue-50     ${
        isCollapsed
          ? "-translate-x-1/2 left-1/2 w-2/4 md:w-1/3 lg:w-1/5 h-16 top-0  cursor-pointer     rounded-lg"
